...
# Mission time window
date_launch = time.Time("2030-05-19 23:57:41.630", scale="utc").tdb
date_arrival = time.Time("2047-05-20 05:57:41.630", scale="utc").tdb
...
plotter.plot_trajectory(
    ss_trans.to_ephem(strategy=EpochsArray(time_range(date_launch, end=date_arrival))).sample(),
    color="black",
